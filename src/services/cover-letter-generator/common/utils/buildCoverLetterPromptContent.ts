...
export const buildCoverLetterPromptContent = (
  ...
  return [
    `Write a cover letter in ${outputLanguage} for the target role or vacancy.`,
    ...
    options.companyName
      ? `Address the letter to this company: ${options.companyName}.`
      : 'The company name is not specified.',
    ...
    'Structure: greeting, concise body, closing line. Do not invent a contact person.',
