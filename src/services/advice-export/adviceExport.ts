import type { ResumeAdvice, ResumeTranslation } from '@common/types';
...
export function downloadTranslationMarkdown(translation: ResumeTranslation, fileName = 'resume-translation.md'): void {
  downloadFile(translation.text, fileName, 'text/markdown');
}

export function downloadTranslationText(translation: ResumeTranslation, fileName = 'resume-translation.txt'): void {
